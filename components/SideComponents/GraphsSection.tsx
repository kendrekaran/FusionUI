...
const Graph_CODE_MAP: Record<GraphType, string> = {
  Graph1: `import React from 'react'
// Graph 1 component code here...
`,
  Graph2: `import React from 'react'
// Graph 2 component code here...
`
}
...
const GraphSection = () => {
  ...
  return (
    <div className='p-4 min-h-screen text-white'>
      <h1 className='text-4xl font-bold'>Graph Sections</h1>
      <p className='text-sm text-gray-400 py-1'>These are some of the Graph Sections</p>

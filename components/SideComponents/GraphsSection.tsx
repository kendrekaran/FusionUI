...
const GraphsSection = () => {
  ...
  const GraphsCode = `Code`

  const copyToClipboard = async () => {
    try {
      await navigator.clipboard.writeText(GraphsCode)
      setCopied(true)
  ...
  return (
    <div className='p-4 bg-gray-950 min-h-screen text-white'>
      <h1 className='text-4xl font-bold'>Graphs Sections</h1>
      <p className='text-sm text-gray-400 py-1'>These are some of the Graphs Sections</p>

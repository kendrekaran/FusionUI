...
export default function Testimonials() {
  ...
  return (
      <div className="relative max-w-6xl mx-auto px-4 border rounded-3xl  border-gray-400  py-8">
        ...
        >
          <h2 className="text-2xl md:text-4xl font-bold text-white">Our Clients</h2>
        ...
        <div className="relative">
          <AnimatePresence mode="wait">
            ...
            >
              <div className="relative mx-auto">
                <div className="relative w-[150px] h-[150px] sm:w-[200px] sm:h-[250px] rounded-2xl overflow-hidden">
                  ...
                  <div className="absolute -top-4 -right-4 w-16 h-16 bg-purple-500/20 rounded-full blur-2xl" />
                  <div className="absolute -bottom-4 -left-4 w-24 h-24 bg-purple-700/20 rounded-full blur-2xl" />
                </div>
          ...
          <div className="flex justify-center gap-4 mt-8 sm:mt-8">
            <Button
              variant="outline"
              size="icon"
              onClick={previous}
              className="rounded-full border-purple-500/20  text-purple-800 hover:bg-purple-900/20 hover:border-purple-500/40 transition-colors"
            >
